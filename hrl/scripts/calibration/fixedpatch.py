...
prsr.add_argument('flnm',default='centralpatch.txt',nargs='?',help="The filename of the file where the results will be stored in the results directory. Default: centralpatch.txt")
