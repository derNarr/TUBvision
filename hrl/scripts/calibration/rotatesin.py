...
prsr.add_argument('flnm',default='wichmann3.txt',nargs='?',help="The filename of the file where the results will be stored in the results directory. Default: wichmann3.txt")
